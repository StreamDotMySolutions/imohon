...
class UserDepartmentRule
{
    ...
    {
        return match ($role) {
            RoleName::Admin, RoleName::GeneralManager => $department->type === DepartmentType::HQ,
    ...
    {
        return match ($role) {
            RoleName::Admin, RoleName::GeneralManager => "The selected department must be an HQ department for the {$role->value} role.",
